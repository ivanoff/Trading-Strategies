...
- [Strategie di trading](#strategie-di-trading)
  - [Strategie](#strategie)
    - [RSI + Bande di Bollinger (rsi\_bb)](#rsi--bande-di-bollinger-rsi_bb)
    - [MACD (macd)](#macd-macd)
    - [RSI Base (rsi\_basic)](#rsi-base-rsi_basic)
    - [SMA Crossover (sma\_cross)](#sma-crossover-sma_cross)
    - [Squeeze delle bande di Bollinger (bb\_squeeze)](#squeeze-delle-bande-di-bollinger-bb_squeeze)
    - [Breakout del canale Donchian/Scambio di tartarughe (donchian)](#breakout-del-canale-donchianscambio-di-tartarughe-donchian)
    - [Ichimoku Cloud Breakout (ichimoku)](#ichimoku-cloud-breakout-ichimoku)
    - [ADX + DMI (adx\_dmi)](#adx--dmi-adx_dmi)
    - [Tendenza OBV (obv\_trend)](#tendenza-obv-obv_trend)
    - [Strategia SuperTrend (supertrend)](#strategia-supertrend-supertrend)
    - [Trend EMA + RSI stocastico (ema\_stoch)](#trend-ema--rsi-stocastico-ema_stoch)
    - [Strategia SAR parabolica (psar)](#strategia-sar-parabolica-psar)
    - [Indice dei flussi di denaro (MFI) (mfi\_div)](#indice-dei-flussi-di-denaro-mfi-mfi_div)
    - [TEMA Crossover (tema\_cross)](#tema-crossover-tema_cross)
    - [Pullback del canale Keltner (keltner\_pullback)](#pullback-del-canale-keltner-keltner_pullback)
    - [Fantastico oscillatore (ao\_saucer)](#fantastico-oscillatore-ao_saucer)
    - [Correzione CCI (cci\_correction)](#correzione-cci-cci_correction)
    - [Tendenza VWAP (vwap\_cross)](#tendenza-vwap-vwap_cross)
    - [RSI stocastico (stoch\_rsi)](#rsi-stocastico-stoch_rsi)
    - [Indice della Forza dell'Anziano (elder\_force)](#indice-della-forza-dellanziano-elder_force)
    - [Williams %R (williams\_r)](#williams-r-williams_r)
    - [MA adattiva di Kaufman (kama\_trend)](#ma-adattiva-di-kaufman-kama_trend)
    - [Tasso di variazione (ROC)](#tasso-di-variazione-roc)
    - [Breakout del canale ATR (volty\_channel)](#breakout-del-canale-atr-volty_channel)
    - [Pendenza di regressione lineare (lin\_reg)](#pendenza-di-regressione-lineare-lin_reg)
    - [Flusso di denaro Chaikin (cmf\_trend)](#flusso-di-denaro-chaikin-cmf_trend)
    - [Indicatore di vortice (vortice)](#indicatore-di-vortice-vortice)
    - [Strategia Aroon (aroon)](#strategia-aroon-aroon)
    - [TRIX (Tripla media esponenziale) (trix\_strat)](#trix-tripla-media-esponenziale-trix_strat)
    - [Curva di Coppock (coppock)](#curva-di-coppock-coppock)
    - [Indice del canale delle materie prime (cci\_trend)](#indice-del-canale-delle-materie-prime-cci_trend)
    - [Tendenza della media mobile dello scafo (hma\_trend)](#tendenza-della-media-mobile-dello-scafo-hma_trend)
    - [Strategia Z-Score (z\_score)](#strategia-z-score-z_score)
    - [VWMA vs SMA (vwma\_cross)](#vwma-vs-sma-vwma_cross)
    - [Connors RSI 2 (rsi\_2)](#connors-rsi-2-rsi_2)
    - [Frattali Williams (fractal\_breakout)](#frattali-williams-fractal_breakout)
    - [Bande di Bollinger di Fibonacci (fib\_bands)](#bande-di-bollinger-di-fibonacci-fib_bands)
    - [Strategia di uscita da Chandelier (chandelier\_trend)](#strategia-di-uscita-da-chandelier-chandelier_trend)
    - [Breakout all'interno della barra (inside\_bar)](#breakout-allinterno-della-barra-inside_bar)
    - [TD sequenziale (semplificato) (td\_seq)](#td-sequenziale-semplificato-td_seq)
    - [Trasformazione di Ehlers Fisher (fisher\_trans)](#trasformazione-di-ehlers-fisher-fisher_trans)
    - [Divergenza RSI (rsi\_div)](#divergenza-rsi-rsi_div)
    - [Tendenza Heikin Ashi (ha\_trend)](#tendenza-heikin-ashi-ha_trend)
    - [Canale di deviazione standard (std\_channel)](#canale-di-deviazione-standard-std_channel)
    - [Inversione dei punti pivot (pivot\_rev)](#inversione-dei-punti-pivot-pivot_rev)
    - [Alligatore Williams (alligatore)](#alligatore-williams-alligatore)
    - [Modello inghiottente (engulfing\_candle)](#modello-inghiottente-engulfing_candle)
    - [McGinley Dinamica (mcginley)](#mcginley-dinamica-mcginley)
    - [Doppia spinta (dual\_thrust)](#doppia-spinta-dual_thrust)
    - [Oscillatore Chande Momentum (cmo\_strat)](#oscillatore-chande-momentum-cmo_strat)
    - [Facilità di movimento (eom\_trend)](#facilità-di-movimento-eom_trend)
    - [Conosci la cosa certa (KST) (kst\_momentum)](#conosci-la-cosa-certa-kst-kst_momentum)
    - [Ciclo di tendenza di Schaff (stc\_cycle)](#ciclo-di-tendenza-di-schaff-stc_cycle)
    - [Filtro indice di discontinuità + EMA (chop\_ema)](#filtro-indice-di-discontinuità--ema-chop_ema)
    - [Media mobile adattiva frattale (frama\_trend)](#media-mobile-adattiva-frattale-frama_trend)
    - [Andamento dei prezzi in volume (vpt\_cross)](#andamento-dei-prezzi-in-volume-vpt_cross)
    - [Laguerre RSI (laguerre\_rsi)](#laguerre-rsi-laguerre_rsi)
    - [Pinbar (Martello/Stella cadente) (pinbar\_reversal)](#pinbar-martellostella-cadente-pinbar_reversal)
    - [Oscillatore del prezzo con trend (dpo\_cycle)](#oscillatore-del-prezzo-con-trend-dpo_cycle)
    - [Breakout del range di apertura (orb\_strat)](#breakout-del-range-di-apertura-orb_strat)
    - [Indice di facilitazione del mercato (bw\_mfi)](#indice-di-facilitazione-del-mercato-bw_mfi)
    - [Linea psicologica (psy\_line)](#linea-psicologica-psy_line)
    - [Tasca dorata di Fibonacci (fib\_golden)](#tasca-dorata-di-fibonacci-fib_golden)
    - [Tre soldati bianchi / Tre corvi neri (candle\_patterns)](#tre-soldati-bianchi--tre-corvi-neri-candle_patterns)
    - [Indice di camminata casuale (rwi\_trend)](#indice-di-camminata-casuale-rwi_trend)
    - [Strategia sull'indice dell'ulcera (ulcer\_strat)](#strategia-sullindice-dellulcera-ulcer_strat)
    - [Corrispondenza pattern k-Vicini più vicini (kNN) (knn\_ml)](#corrispondenza-pattern-k-vicini-più-vicini-knn-knn_ml)
    - [Teoria della scatola di Darvas (darvas\_box)](#teoria-della-scatola-di-darvas-darvas_box)
    - [Indice Elder-Ray (elder\_ray)](#indice-elder-ray-elder_ray)
    - [Centro di gravità (cog\_ehlers)](#centro-di-gravità-cog_ehlers)
    - [Entropia di Shannon (entropy\_chaos)](#entropia-di-shannon-entropy_chaos)
    - [Indice di vigore relativo (rvi\_trend)](#indice-di-vigore-relativo-rvi_trend)
    - [VSTOP (arresto della volatilità) (vstop\_trend)](#vstop-arresto-della-volatilità-vstop_trend)
    - [Cosa scegliere dopo?](#cosa-scegliere-dopo)
    - [Indicatore Squeeze Momentum (lazybear\_squeeze)](#indicatore-squeeze-momentum-lazybear_squeeze)
    - [Strategia con esponente di Hurst (hurst\_exponent)](#strategia-con-esponente-di-hurst-hurst_exponent)
    - [Tendenza Renko sintetica (renko\_synthetic)](#tendenza-renko-sintetica-renko_synthetic)
    - [Attivatore Gann Hi-Lo (gann\_hilo)](#attivatore-gann-hi-lo-gann_hilo)
    - [Rifiuto POC del profilo volume (vpvr\_poc)](#rifiuto-poc-del-profilo-volume-vpvr_poc)
    - [Rimbalzo DCA (media del costo in dollari) (dca\_martingale)](#rimbalzo-dca-media-del-costo-in-dollari-dca_martingale)
    - [Trading su triplo schermo (triple\_screen)](#trading-su-triplo-schermo-triple_screen)
  - [Strategie combinate](#strategie-combinate)
    - [Metodo a triplo schermo (triple\_screen\_custom)](#metodo-a-triplo-schermo-triple_screen_custom)
    - [Bollinger Breakout + MFI (bb\_mfi\_breakout)](#bollinger-breakout--mfi-bb_mfi_breakout)
    - [Ichimoku Nuvola + MACD (ichimoku\_macd)](#ichimoku-nuvola--macd-ichimoku_macd)
    - [ADX + SAR parabolico (adx\_psar)](#adx--sar-parabolico-adx_psar)
    - [Pullback SMA 50/200 (golden\_cross\_pullback)](#pullback-sma-50200-golden_cross_pullback)
    - [Regressione lineare + punteggio Z (stats\_arbitrage)](#regressione-lineare--punteggio-z-stats_arbitrage)
    - [Metodo a triplo schermo (triple\_screen\_ema)](#metodo-a-triplo-schermo-triple_screen_ema)
    - [SMA Croce d'Oro Pullback (sma\_pullback)](#sma-croce-doro-pullback-sma_pullback)
    - [SuperTrend + StochRSI (super\_stoch)](#supertrend--stochrsi-super_stoch)
    - [Breakout di Bollinger + MFI (bb\_mfi)](#breakout-di-bollinger--mfi-bb_mfi)
    - [Regressione lineare + punteggio Z (linreg\_zscore)](#regressione-lineare--punteggio-z-linreg_zscore)
    - [Il sistema di trend "Fortezza" (trend\_momentum\_volatility\_volume)](#il-sistema-di-trend-fortezza-trend_momentum_volatility_volume)
    - [Il "cuoio capelluto perfetto" (heikin\_ashi\_ema\_stochrsi\_atr)](#il-cuoio-capelluto-perfetto-heikin_ashi_ema_stochrsi_atr)
    - [Divergence Hunter Pro (rsi\_cci\_mfi\_ema)](#divergence-hunter-pro-rsi_cci_mfi_ema)
    - [Compressione avanzata (bollinger\_keltner\_momentum\_adx)](#compressione-avanzata-bollinger_keltner_momentum_adx)
    - [Ichimoku "Tutto esaurito" (tenkan\_kijun\_cloud\_chikou\_rsi)](#ichimoku-tutto-esaurito-tenkan_kijun_cloud_chikou_rsi)
    - [Strategia istituzionale VWAP (vwap\_ema\_volume\_profile\_rsi)](#strategia-istituzionale-vwap-vwap_ema_volume_profile_rsi)
    - [Il "cecchino delle tendenze" (parabolic\_sar\_adx\_ema\_macd)](#il-cecchino-delle-tendenze-parabolic_sar_adx_ema_macd)
    - [Il sistema "Sentiero delle balene" (volume\_trend\_value)](#il-sistema-sentiero-delle-balene-volume_trend_value)
    - [L'inversione della "banda elastica" (mean\_reversion\_trend\_filter)](#linversione-della-banda-elastica-mean_reversion_trend_filter)
    - [Lo "tsunami Guppy" (gmma\_adx)](#lo-tsunami-guppy-gmma_adx)
    - [Il canale "Regressione quantistica" (linear\_reg\_pearson\_r\_atr)](#il-canale-regressione-quantistica-linear_reg_pearson_r_atr)
    - [Il "Caos d'Oro" (ichimoku\_bill\_williams\_fractals\_ao)](#il-caos-doro-ichimoku_bill_williams_fractals_ao)
    - [Il sistema "Velocity" (hull\_ma\_laguerre\_rsi\_volatility\_stop)](#il-sistema-velocity-hull_ma_laguerre_rsi_volatility_stop)
    - [La "Confluenza di Fibonacci" (auto\_fibs\_ema\_50\_stochastic)](#la-confluenza-di-fibonacci-auto_fibs_ema_50_stochastic)
  - [Consigli](#consigli)
## Strategie
