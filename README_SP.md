...
- [Estrategias comerciales](#estrategias-comerciales)
  - [Estrategias](#estrategias)
    - [RSI + Bandas de Bollinger (rsi\_bb)](#rsi--bandas-de-bollinger-rsi_bb)
    - [MACD (macd)](#macd-macd)
    - [RSI Básico (rsi\_basic)](#rsi-básico-rsi_basic)
    - [Cruce SMA (sma\_cross)](#cruce-sma-sma_cross)
    - [Apretón de la banda de Bollinger (bb\_squeeze)](#apretón-de-la-banda-de-bollinger-bb_squeeze)
    - [Fuga del canal Donchian / Comercio de tortugas (donchian)](#fuga-del-canal-donchian--comercio-de-tortugas-donchian)
    - [Fuga de la nube de Ichimoku (ichimoku)](#fuga-de-la-nube-de-ichimoku-ichimoku)
    - [ADX + DMI (adx\_dmi)](#adx--dmi-adx_dmi)
    - [Tendencia OBV (obv\_trend)](#tendencia-obv-obv_trend)
    - [Estrategia SuperTrend (supertendencia)](#estrategia-supertrend-supertendencia)
    - [Tendencia EMA + RSI estocástico (ema\_stoch)](#tendencia-ema--rsi-estocástico-ema_stoch)
    - [Estrategia SAR parabólica (psar)](#estrategia-sar-parabólica-psar)
    - [Índice de flujo de dinero (IMF) (mfi\_div)](#índice-de-flujo-de-dinero-imf-mfi_div)
    - [Cruce de TEMA (tema\_cross)](#cruce-de-tema-tema_cross)
    - [Retroceso del canal Keltner (keltner\_pullback)](#retroceso-del-canal-keltner-keltner_pullback)
    - [Oscilador impresionante (ao\_saucer)](#oscilador-impresionante-ao_saucer)
    - [Corrección CCI (cci\_corrección)](#corrección-cci-cci_corrección)
    - [Tendencia VWAP (vwap\_cross)](#tendencia-vwap-vwap_cross)
    - [RSI estocástico (stoch\_rsi)](#rsi-estocástico-stoch_rsi)
    - [Índice de fuerza del anciano (elder\_force)](#índice-de-fuerza-del-anciano-elder_force)
    - [Williams %R (williams\_r)](#williams-r-williams_r)
    - [MA adaptativo de Kaufman (kama\_trend)](#ma-adaptativo-de-kaufman-kama_trend)
    - [Tasa de cambio (roc)](#tasa-de-cambio-roc)
    - [Desglose del canal ATR (volty\_channel)](#desglose-del-canal-atr-volty_channel)
    - [Pendiente de regresión lineal (lin\_reg)](#pendiente-de-regresión-lineal-lin_reg)
    - [Flujo de dinero de Chaikin (cmf\_trend)](#flujo-de-dinero-de-chaikin-cmf_trend)
    - [Indicador de vórtice (vórtice)](#indicador-de-vórtice-vórtice)
    - [Estrategia Aroon (aroon)](#estrategia-aroon-aroon)
    - [TRIX (Promedio exponencial triple) (trix\_strat)](#trix-promedio-exponencial-triple-trix_strat)
    - [Curva de Coppock (coppock)](#curva-de-coppock-coppock)
    - [Índice de canales de productos básicos (cci\_trend)](#índice-de-canales-de-productos-básicos-cci_trend)
    - [Tendencia de media móvil del casco (hma\_trend)](#tendencia-de-media-móvil-del-casco-hma_trend)
    - [Estrategia de puntuación Z (z\_score)](#estrategia-de-puntuación-z-z_score)
    - [VWMA frente a SMA (vwma\_cross)](#vwma-frente-a-sma-vwma_cross)
    - [Connors RSI 2 (rsi\_2)](#connors-rsi-2-rsi_2)
    - [Fractales de Williams (fractal\_breakout)](#fractales-de-williams-fractal_breakout)
    - [Bandas de Fibonacci Bollinger (fib\_bands)](#bandas-de-fibonacci-bollinger-fib_bands)
    - [Estrategia de salida de la lámpara de araña (chandelier\_trend)](#estrategia-de-salida-de-la-lámpara-de-araña-chandelier_trend)
    - [Desglose de la barra interior (inside\_bar)](#desglose-de-la-barra-interior-inside_bar)
    - [TD secuencial (simplificado) (td\_seq)](#td-secuencial-simplificado-td_seq)
    - [Transformación de Ehlers Fisher (fisher\_trans)](#transformación-de-ehlers-fisher-fisher_trans)
    - [Divergencia RSI (rsi\_div)](#divergencia-rsi-rsi_div)
    - [Tendencia Heikin Ashi (ha\_trend)](#tendencia-heikin-ashi-ha_trend)
    - [Canal de desviación estándar (std\_channel)](#canal-de-desviación-estándar-std_channel)
    - [Inversión de puntos de pivote (pivot\_rev)](#inversión-de-puntos-de-pivote-pivot_rev)
    - [Caimán Williams (cocodrilo)](#caimán-williams-cocodrilo)
    - [Patrón envolvente (engulfing\_candle)](#patrón-envolvente-engulfing_candle)
    - [McGinley dinámico (mcginley)](#mcginley-dinámico-mcginley)
    - [Doble empuje (dual\_thrust)](#doble-empuje-dual_thrust)
    - [Oscilador de impulso Chande (cmo\_strat)](#oscilador-de-impulso-chande-cmo_strat)
    - [Facilidad de movimiento (eom\_trend)](#facilidad-de-movimiento-eom_trend)
    - [Sepa lo seguro (KST) (kst\_momentum)](#sepa-lo-seguro-kst-kst_momentum)
    - [Ciclo de tendencia de Schaff (stc\_cycle)](#ciclo-de-tendencia-de-schaff-stc_cycle)
    - [Filtro de índice de agitación + EMA (chop\_ema)](#filtro-de-índice-de-agitación--ema-chop_ema)
    - [Media móvil adaptativa fractal (frama\_trend)](#media-móvil-adaptativa-fractal-frama_trend)
    - [Tendencia del precio por volumen (vpt\_cross)](#tendencia-del-precio-por-volumen-vpt_cross)
    - [Laguerre RSI (laguerre\_rsi)](#laguerre-rsi-laguerre_rsi)
    - [Pinbar (martillo/estrella fugaz) (pinbar\_reversal)](#pinbar-martilloestrella-fugaz-pinbar_reversal)
    - [Oscilador de precios sin tendencia (dpo\_cycle)](#oscilador-de-precios-sin-tendencia-dpo_cycle)
    - [Ruptura del rango de apertura (orb\_strat)](#ruptura-del-rango-de-apertura-orb_strat)
    - [Índice de facilitación del mercado (bw\_mfi)](#índice-de-facilitación-del-mercado-bw_mfi)
    - [Línea psicológica (psy\_line)](#línea-psicológica-psy_line)
    - [Bolsillo dorado de Fibonacci (fib\_golden)](#bolsillo-dorado-de-fibonacci-fib_golden)
    - [Tres soldados blancos / Tres cuervos negros (candle\_patterns)](#tres-soldados-blancos--tres-cuervos-negros-candle_patterns)
    - [Índice de caminata aleatoria (rwi\_trend)](#índice-de-caminata-aleatoria-rwi_trend)
    - [Estrategia de índice de úlceras (ulcer\_strat)](#estrategia-de-índice-de-úlceras-ulcer_strat)
    - [Coincidencia de patrones de k-vecinos más cercanos (kNN) (knn\_ml)](#coincidencia-de-patrones-de-k-vecinos-más-cercanos-knn-knn_ml)
    - [Teoría de la caja de Darvas (darvas\_box)](#teoría-de-la-caja-de-darvas-darvas_box)
    - [Índice Elder-Ray (elder\_ray)](#índice-elder-ray-elder_ray)
    - [Centro de gravedad (cog\_ehlers)](#centro-de-gravedad-cog_ehlers)
    - [Entropía de Shannon (entropía\_caos)](#entropía-de-shannon-entropía_caos)
    - [Índice de vigor relativo (rvi\_trend)](#índice-de-vigor-relativo-rvi_trend)
    - [VSTOP (Parada de volatilidad) (vstop\_trend)](#vstop-parada-de-volatilidad-vstop_trend)
    - [¿Qué elegir a continuación?](#qué-elegir-a-continuación)
    - [Indicador de impulso de compresión (lazybear\_squeeze)](#indicador-de-impulso-de-compresión-lazybear_squeeze)
    - [Estrategia del exponente de Hurst (hurst\_exponent)](#estrategia-del-exponente-de-hurst-hurst_exponent)
    - [Tendencia Renko sintética (renko\_synthetic)](#tendencia-renko-sintética-renko_synthetic)
    - [Activador Gann Hi-Lo (gann\_hilo)](#activador-gann-hi-lo-gann_hilo)
    - [Rechazo de POC del perfil de volumen (vpvr\_poc)](#rechazo-de-poc-del-perfil-de-volumen-vpvr_poc)
    - [Rebote de DCA (promedio de costos en dólares) (dca\_martingale)](#rebote-de-dca-promedio-de-costos-en-dólares-dca_martingale)
    - [Comercio de pantalla triple (triple\_screen)](#comercio-de-pantalla-triple-triple_screen)
  - [Estrategias combinadas](#estrategias-combinadas)
    - [Método de pantalla triple (triple\_screen\_custom)](#método-de-pantalla-triple-triple_screen_custom)
    - [Fuga de Bollinger + IMF (bb\_mfi\_breakout)](#fuga-de-bollinger--imf-bb_mfi_breakout)
    - [Nube Ichimoku + MACD (ichimoku\_macd)](#nube-ichimoku--macd-ichimoku_macd)
    - [ADX + SAR parabólico (adx\_psar)](#adx--sar-parabólico-adx_psar)
    - [Retroceso SMA 50/200 (golden\_cross\_pullback)](#retroceso-sma-50200-golden_cross_pullback)
    - [Regresión lineal + puntuación Z (stats\_arbitrage)](#regresión-lineal--puntuación-z-stats_arbitrage)
    - [Método de pantalla triple (triple\_screen\_ema)](#método-de-pantalla-triple-triple_screen_ema)
    - [Retroceso de la cruz dorada de SMA (sma\_pullback)](#retroceso-de-la-cruz-dorada-de-sma-sma_pullback)
    - [SuperTrend + StochRSI (super\_stoch)](#supertrend--stochrsi-super_stoch)
    - [Fuga de Bollinger + IMF (bb\_mfi)](#fuga-de-bollinger--imf-bb_mfi)
    - [Regresión lineal + puntuación Z (linreg\_zscore)](#regresión-lineal--puntuación-z-linreg_zscore)
    - [El sistema de tendencias "Fortaleza" (trend\_momentum\_volatility\_volume)](#el-sistema-de-tendencias-fortaleza-trend_momentum_volatility_volume)
    - [El "cuero cabelludo perfecto" (heikin\_ashi\_ema\_stochrsi\_atr)](#el-cuero-cabelludo-perfecto-heikin_ashi_ema_stochrsi_atr)
    - [Cazador de divergencias Pro (rsi\_cci\_mfi\_ema)](#cazador-de-divergencias-pro-rsi_cci_mfi_ema)
    - [Apretón avanzado (bollinger\_keltner\_momentum\_adx)](#apretón-avanzado-bollinger_keltner_momentum_adx)
    - [Ichimoku "Tres por tres" (tenkan\_kijun\_cloud\_chikou\_rsi)](#ichimoku-tres-por-tres-tenkan_kijun_cloud_chikou_rsi)
    - [Estrategia institucional VWAP (vwap\_ema\_volume\_profile\_rsi)](#estrategia-institucional-vwap-vwap_ema_volume_profile_rsi)
    - [El "Francotirador de tendencias" (parabolic\_sar\_adx\_ema\_macd)](#el-francotirador-de-tendencias-parabolic_sar_adx_ema_macd)
    - [El sistema "Ruta de las Ballenas" (volume\_trend\_value)](#el-sistema-ruta-de-las-ballenas-volume_trend_value)
    - [La reversión de la "banda elástica" (mean\_reversion\_trend\_filter)](#la-reversión-de-la-banda-elástica-mean_reversion_trend_filter)
    - [El "Tsunami Guppy" (gmma\_adx)](#el-tsunami-guppy-gmma_adx)
    - [El canal "Regresión cuántica" (linear\_reg\_pearson\_r\_atr)](#el-canal-regresión-cuántica-linear_reg_pearson_r_atr)
    - [El "Caos Dorado" (ichimoku\_bill\_williams\_fractals\_ao)](#el-caos-dorado-ichimoku_bill_williams_fractals_ao)
    - [El sistema "Velocidad" (hull\_ma\_laguerre\_rsi\_volatility\_stop)](#el-sistema-velocidad-hull_ma_laguerre_rsi_volatility_stop)
    - [La "Confluencia de Fibonacci" (auto\_fibs\_ema\_50\_stochastic)](#la-confluencia-de-fibonacci-auto_fibs_ema_50_stochastic)
